    ...
    <div className="pt-28 pb-24">
      <div className="container space-y-12">
        <header className="space-y-5 text-center">
          <span className="inline-flex items-center rounded-full border border-white/10 bg-white/5 px-4 py-1 text-[0.65rem] uppercase tracking-[0.32em] text-muted-foreground/80">
            Capabilities
          </span>
              ...
              <div className="relative">
                <AspectRatio ratio={16 / 9}>
                  <img
                    ...
                    className="h-full w-full rounded-t-[1.9rem] object-cover"
                    loading="lazy"
                  />
                </AspectRatio>
