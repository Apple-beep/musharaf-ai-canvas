export const profile = {
  ...
  focus: [
    ...
    "Crafting cloud-native systems with observability, performance, and beauty in equal measure.",
  ],
  availability: {
  ...
  currentSpotlight: {
    label: "Latest drop",
    description: "Hover-driven data atlas reimagined as an ambient galaxy for fast exploratory insight mining.",
  },
  signal: [
    {
      label: "Architectural mindset",
      detail: "Spatial design thinking keeps my interfaces structured, discoverable, and human-first.",
    },
    {
      label: "Community builder",
      detail: "Led 40+ studio-style workshops that help classmates go from confusion to clarity.",
    },
  ],
  metrics: [
